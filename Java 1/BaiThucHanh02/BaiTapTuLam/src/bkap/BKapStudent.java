...
public class BKapStudent extends Mark{
    ...
    public void input() {
        ...
        while(true){
            if(this.courseName.length()>0 )
                ...
                System.err.printf("\tTên khóa học không được để trống\n");
    ...
    public void display() {
        ...
        builder.append((String.format("%10s",this.courseName)));
        builder.append("\t|");
        builder.append((String.format("%10s",this.getScholarShip())));
