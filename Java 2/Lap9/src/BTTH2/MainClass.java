...
public class MainClass {
    ...
    public static void main(String[] args) {
        MainClass main = new MainClass();
            main.printInvoice(1200, 35.5, Calendar.getInstance().getTime(),Locale.FRANCE);
            main.printInvoice(1200, 35.5, Calendar.getInstance().getTime(),Locale.GERMANY);
            main.printInvoice(1200, 35.5, Calendar.getInstance().getTime(), Locale.JAPAN);
            main.printInvoice(1200, 35.5, Calendar.getInstance().getTime(),Locale.KOREA);
